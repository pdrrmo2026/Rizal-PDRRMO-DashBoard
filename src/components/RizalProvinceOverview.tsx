        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative z-10">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h2 className="text-2xl font-bold text-white">Province Risk Snapshot</h2>
            </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 backdrop-blur-sm shadow-lg">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-white">Priority Hotspots</h3>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                { name: 'San Leandro / Tanay', risk: 'Moderate', reason: 'Mountainous slopes', color: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/20' },
              ].map((muni) => (
          ...
          <section className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 backdrop-blur-sm shadow-lg">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div className="bg-slate-950/50 border border-slate-800 rounded-lg p-4 text-center">
                ...
                <p className="text-[10px] text-slate-400 uppercase tracking-wide mt-1">At-Risk Barangays</p>
              </div>
              <div className="bg-slate-950/50 border border-slate-800 rounded-lg p-4 text-center">
