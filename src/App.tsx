                        ...
                        const tabs = (
                          <div className={`flex items-center gap-1.5 p-1 bg-gray-950/50 border ${isVideos ? 'border-red-500/20' : 'border-indigo-500/20'} rounded-xl w-fit backdrop-blur-sm`}>
                            <button
                              ...
                              className={`flex items-center gap-2 px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${iecSubTab === 'videos'
                            ...
                            <button
                              ...
                              className={`flex items-center gap-2 px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${iecSubTab === 'posters'
      ...
      <Route
        ...
        element={
          <div style={{ padding: 20, color: "white" }}>
            <h1>Evacuation Details Page Working</h1>
          </div>
        }
      />
    </Routes>
