...
// browser-external:xmldom
var require_xmldom = __commonJS({
  "browser-external:xmldom"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "xmldom" has been externalized for browser compatibility. Cannot access "xmldom.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var require_togeojson = __commonJS({
  "node_modules/togeojson/togeojson.js"(exports, module) {
    var toGeoJSON = (function() {
      ...
      if (typeof XMLSerializer !== "undefined") {
        ...
        serializer = new (require_xmldom()).XMLSerializer();
      }
      ...
      var t = {
        kml: function(doc) {
          ...
          function getPlacemark(root) {
            var geomsAndTimes = getGeometry(root), i, properties = {}, name = nodeVal(get1(root, "name")), styleUrl = nodeVal(get1(root, "styleUrl")), description = nodeVal(get1(root, "description")), timeSpan = get1(root, "TimeSpan"), timeStamp = get1(root, "TimeStamp"), extendedData = get1(root, "ExtendedData"), lineStyle = get1(root, "LineStyle"), polyStyle = get1(root, "PolyStyle"), visibility = get1(root, "visibility");
